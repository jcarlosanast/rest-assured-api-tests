...
public class UserJsonTest {
    ...
    public void deveVerificarListaNaRaiz() {
        ...
        //OR
            ...
            .body("age[1]",is(25))
        //Representação de uma lista que tenha um objeto
            .body("filhos.name",hasItem(Arrays.asList("Zezinho","Luizinho")))

        //O fno 5678 representa que o valor é Flout
    ...
    public void devoFazerVerificacaoAvancada() {
        ...
        .then()
            ...
            //[-1 inicia a varredura da lista de baixo para cima]
            .body("findAll{it.age <= 25}[-1].name", is("Ana Júlia"))

            //Verifica a informaçãpo de toda lista
            .body("find{it.age <= 25}.name", is("Maria Joaquina"))

            .body("findAll{it.name.contains('n')}.name", hasItems("Maria Joaquina", "Ana Júlia"))

            //Consulta itens com amis de 10 caracteres
